...
class TestDependencies:
    ...
    @pytest.fixture(scope="class")
    def parsed_query_3(self, prepared_core, parser):
    ...
    def test_format_is_parsed(self, prepared_core, parser, parsed_query_3):
    ...
    def test_equal_to_is_parsed(self, prepared_core, parser, parsed_query_3):
    ...
    def test_equal_sign_to_is_parsed(self, prepared_core, parser, parsed_query_3):
    ...
    def test_smaller_then_is_parsed(self, prepared_core, parser, parsed_query_3):
    ...
    def test_smaller_then_or_equal_is_parsed(self, prepared_core, parser, parsed_query_3):
    ...
    def test_greater_then_is_parsed(self, prepared_core, parser, parsed_query_3):
    ...
    def test_greater_then_or_equal_is_parsed(self, prepared_core, parser, parsed_query_3):
