...
def test_valid_string_to_dates_for_greater_dependency(
        prepared_core, request, prepared_table, prepared_table_2, min_req_for_prepared_table):
    test_case_title = request.node.name
    prepare_const = prepared_table.has_min_reqs.has_constraints[0]
    prepare_const.has_picks = ["2020-12-30"]
    ...
    assert realized_case["internal_test_table_01"][0]['column_02'] == "2020-12-30"
    assert prepared_table_2.has_columns[3].has_data_type.parse_if_needed(
        realized_case["internal_test_table_01"][0]['column_02']) < \
           prepared_table_2.has_columns[3].has_data_type.parse_if_needed(
               realized_case['internal_test_table_02'][0]['column_04'])


def test_invalid_string_to_dates_for_greater_dependency(
        prepared_core, request, prepared_table, prepared_table_2, min_req_for_prepared_table):
    test_case_title = request.node.name
    prepare_const = prepared_table.has_min_reqs.has_constraints[0]
    prepare_const.has_picks = ["2020-12-30 dd"]
...
def test_valid_greater_or_equal_dependency_max_case(
        prepared_core, request, prepared_table, prepared_table_2, min_req_for_prepared_table):
    test_case_title = request.node.name
    prepare_const = prepared_table.has_min_reqs.has_constraints[0]
    prepare_const.has_picks = ["2020-12-30"]
...
#
#     assert prepared_table_2.has_columns[1].has_data_type.convert_to_numeric_value(
#             realized_case["internal_test_table_02"][0]['column_02']) < \
#            prepared_table.has_columns[1].has_data_type.convert_to_numeric_value(
...
#     assert prepared_table_2.has_columns[4].has_data_type.convert_to_numeric_value(
#             realized_case["internal_test_table_02"][0]['column_05']
#     ) > datetime.strptime(realized_case['internal_test_table_01'][0]['column_06'], EXPECTED_DATE_FORMAT)
#
#
...
#     assert realized_case["internal_test_table_01"][0]['column_06']
#     assert datetime.strptime(realized_case["internal_test_table_02"][0]['column_04'], EXPECTED_DATE_FORMAT) < \
#         prepared_table.has_columns[5].has_data_type.convert_to_numeric_value(
#             realized_case["internal_test_table_01"][0]['column_06']
#         )
#
#
...
#     assert realized_case
#     assert realized_case["internal_test_table_01"][0]['column_06']
#     assert prepared_table_2.has_columns[3].has_data_type.convert_to_numeric_value(
#             realized_case["internal_test_table_02"][0]['column_04']
#     ) >= prepared_table.has_columns[5].has_data_type.convert_to_numeric_value(
#         realized_case['internal_test_table_01'][0]['column_06']
#     )
